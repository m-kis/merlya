...
class TestSkillWizardPromptPatterns:
    ...
    @pytest.mark.asyncio
    async def test_prompt_patterns_from_category(self):
        """Test selecting patterns from category."""
        ...
        assert patterns == COMMON_PATTERNS["diagnostic"]

    @pytest.mark.asyncio
    async def test_prompt_patterns_custom(self):
        """Test custom patterns input."""
    ...
    @pytest.mark.asyncio
    async def test_prompt_patterns_default(self):
        """Test default pattern when nothing provided."""
        wizard = SkillWizard()
