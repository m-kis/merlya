"""
Verification script for CacheManager refactoring.
"""
import time
import unittest
...
try:
    from merlya.context.cache_manager import CacheManager, CacheConfig, get_cache_manager
except ImportError:
    # Fallback for after refactor
    from merlya.context.cache_manager.manager import CacheManager
    from merlya.context.cache_manager.models import CacheConfig
    from merlya.context.cache_manager import get_cache_manager
