...
class InventoryManager:
    ...
    def handle_add_host(self, args: List[str], repl: Optional["MerlyaREPL"] = None) -> bool:
        """
    ...
    def handle_ssh_key(self, args: List[str], repl: Optional["MerlyaREPL"] = None) -> bool:
        """
    ...
    def _show_ssh_key_help(self, repl: Optional["MerlyaREPL"] = None) -> None:
    ...
    def _show_global_ssh_config(self, repl: Optional["MerlyaREPL"] = None) -> None:
