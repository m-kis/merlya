...
class InventoryCommandHandler:
    ...
    def _show_help(self) -> bool:
        ...
        console.print("  /inventory ssh-key                         Show usage and current config")
        ...
        console.print("  /inventory ssh-key <host> show             Show host SSH key config")
        console.print("  /inventory ssh-key <host> clear            Clear host SSH key config")
        console.print()
