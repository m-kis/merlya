...
def main():
    """Main entry point."""
    console.print("\n[bold cyan]🧙 Merlya[/bold cyan]")
    console.print("[dim]AI-Powered Infrastructure Orchestration[/dim]\n")

    # 1. Add current directory to path to ensure merlya is importable
    ...
    try:
        ...
        console.print(f"[red]Critical Error: Could not import Merlya components.[/red]")
